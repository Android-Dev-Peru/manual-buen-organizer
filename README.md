...
2. Crear grupo en whatsapp con speaker y team organizer. Formato Meetup #XX- ADP(Android Dev Perú)
3. Crear flyer (solicitar foto a speaker), verificar con speaker y publicitar en redes.
...
- Explicar de va tratar el meetup y los temas, así como indicar que dejen sus preguntas
...
4. Solicitar requerimientos al Local
	- Preguntar restricciones de acceso
...
6. Sobre el acceso
	- Al publicar el evento, se usa alguna herramienta para registrar a los asistentes. Se solicita nombre completos y Dni. Supongo que para el covid (carnet de vacunación con 3 vacunas)
	- Se crea una lista aparte para organizers y speakers

7. Cierre de registro y envío de asistentes
	- 3 días antes o como lo solicite el local, se cierra el registro, se depura la lista y se envía vía email un excel con los asistentes y otra lista con organizers y speaker.
...
3. Llenar el formulario
	...
	- Descripción: Ejemplo de contenido, actualizar datos: revisar el template
	- Privacidad: Public
...
Eliminar un streaming en Stream Yard
